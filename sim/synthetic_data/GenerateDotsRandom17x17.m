%GENERATEDOTSRANDOM17x17 Generate 17x17 randomly distributed microneedle
...
needle_array_size = [17, 17]; % microneedle array sizeblank = zeros(needle_array_size, 'logical');
...
allow_inner = true; % allow innner pixels
