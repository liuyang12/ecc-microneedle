%GENERATEDOTSRANDOM12x12 Generate 12x12 randomly distributed microneedle
...
needle_array_size = [12, 12]; % microneedle array sizeblank = zeros(needle_array_size, 'logical');
rect_raw_size = [256, 256]; % raw image size for rectification
corner_size = 2; % p - corner size pxp for orientation
